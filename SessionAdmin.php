				...
				<div class="container clearfix">
					...
					<div class="heading-block center nobottomborder">
						<div class="feature-box fbox-center fbox-light fbox-plain">
							<div class="fbox-icon">
								<a href="index.php"><i class="icon-warning-sign"></i></a>
							</div>
					</div>
						<h1>Session Expired!!!</h1>
						<span>Please Login Again.</span>
						<br><br><br>
						<a href="php/logout1.php" class="button button-xlarge button-circle button-blue"><i class="icon-warning-sign"></i>Login Again!!</a>
