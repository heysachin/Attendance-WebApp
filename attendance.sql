...
--
-- Host: localhost:3306
-- Generation Time: Jun 22, 2018 at 03:31 AM
...
INSERT INTO `attendance` (`SIndex`, `StudId`, `Total`, `Missed`, `Date`) VALUES
(1, 'NSS15CS001', 3, 1, '04-04-2018'),
(1, 'NSS15CS002', 3, 3, '04-04-2018'),
(1, 'NSS15CS003', 3, 2, '04-04-2018'),
(1, 'NSS15CS004', 3, 0, '04-04-2018'),
(1, 'NSS15CS050', 3, 0, '04-04-2018'),
(4, '11', 2, 1, '20-06-2018'),
(4, '11', 9, 2, '22-06-2018');
...
INSERT INTO `internals` (`SIndex`, `StudID`, `First`, `Second`, `Third`, `Retest`) VALUES
(1, 'NSS15CS001', 19, 20, 1, 0),
(1, 'NSS15CS002', 99, 0, 2, 0),
(1, 'NSS15CS003', 99, 0, 3, 20),
(1, 'NSS15CS004', 0, 20, 4, 0),
(1, 'NSS15CS050', 0, 99, 5, 40),
(4, '11', 45, 34, 0, 0);
...
(4, 'sadad', 'akjfnalsdfjn', 1, 'CSE003', 1, 1);
...
ALTER TABLE `attendance`
  ...
  ADD UNIQUE KEY `Tid_2` (`StudId`,`Date`) USING BTREE;
...
ALTER TABLE `internals`
  ADD PRIMARY KEY (`SIndex`,`StudID`),
  ADD UNIQUE KEY `SubID_2` (`StudID`) USING BTREE;
...
--
ALTER TABLE `subjects`
  MODIFY `SIndex` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`SIndex`) REFERENCES `subjects` (`SIndex`),
  ADD CONSTRAINT `attendance_ibfk_2` FOREIGN KEY (`StudId`) REFERENCES `student` (`StudId`);
...
ALTER TABLE `internals`
  ...
  ADD CONSTRAINT `internals_ibfk_3` FOREIGN KEY (`SIndex`) REFERENCES `subjects` (`SIndex`);
